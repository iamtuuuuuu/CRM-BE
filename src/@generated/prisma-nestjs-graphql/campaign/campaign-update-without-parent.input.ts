...
import { CampaignUpdateOneWithoutParentInput } from './campaign-update-one-without-parent.input';
...
@InputType()
export class CampaignUpdateWithoutParentInput {
    ...
    @Field(() => CampaignUpdateOneWithoutParentInput, {nullable:true})
    Campaign?: CampaignUpdateOneWithoutParentInput;
