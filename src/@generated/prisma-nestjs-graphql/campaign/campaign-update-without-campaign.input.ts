...
import { CampaignUpdateOneWithoutCampaignInput } from './campaign-update-one-without-campaign.input';
...
@InputType()
export class CampaignUpdateWithoutCampaignInput {
    ...
    @Field(() => CampaignUpdateOneWithoutCampaignInput, {nullable:true})
    parent?: CampaignUpdateOneWithoutCampaignInput;
