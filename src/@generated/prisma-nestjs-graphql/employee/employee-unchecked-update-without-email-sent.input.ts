...
import { EmployeeRoleUncheckedUpdateManyWithoutEmployeeInput } from '../employee-role/employee-role-unchecked-update-many-without-employee.input';
import { ProblemUncheckedUpdateManyWithoutEmployeeInput } from '../problem/problem-unchecked-update-many-without-employee.input';

@InputType()
export class EmployeeUncheckedUpdateWithoutEmailSentInput {
    ...
    @Field(() => EmployeeRoleUncheckedUpdateManyWithoutEmployeeInput, {nullable:true})
    EmployeeRole?: EmployeeRoleUncheckedUpdateManyWithoutEmployeeInput;
