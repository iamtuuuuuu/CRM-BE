...
import { ProblemUpdateManyWithoutCustomerInput } from '../problem/problem-update-many-without-customer.input';

@InputType()
export class CustomerUpdateWithoutCustomerCampaignInput {
    ...
    @Field(() => ProblemUpdateManyWithoutCustomerInput, {nullable:true})
    Problem?: ProblemUpdateManyWithoutCustomerInput;
}
